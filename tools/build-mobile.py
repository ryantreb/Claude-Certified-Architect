...
SW_JS = r"""/* Sigilbound mobile offline cache — generated by tools/build-mobile.py; do not hand-edit.
...
self.addEventListener("activate", (e) => {
  e.waitUntil((async () => {
    ...
    await Promise.all(
      keys.filter((k) => k.startsWith("sigilbound-mobile-") && k !== CACHE)
...
def main() -> None:
    ...
    head_tags = (
        ...
        '<meta name="apple-mobile-web-app-title" content="Sigilbound">'
    )
    hidx = slim.find("</head>")
    if hidx == -1:
