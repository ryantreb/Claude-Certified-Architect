...
const HEROES={
  /* guild companions: presets M3 (bearded), F2, M4 (no tint), F1 through the
     same CompositeHead tables */
  headCompVan:[
    {sym:'hm_headSkin_3',tint:SKIN[6]},
    {sym:'hm_facial_2',tint:HAIR[4]},
    {sym:'hm_eyes'},
    {sym:'hm_hair_4',tint:HAIR[4]}],
  headCompSha:[
    {sym:'hf_headSkin_5',tint:SKIN[4]},
    {sym:'hf_eyes'},
    {sym:'hf_hair_12',tint:HAIR[5]}],
  headCompCas:[
    {sym:'hm_headSkin_4',tint:SKIN[9]},
    {sym:'hm_facial_3',tint:HAIR[2]},
    {sym:'hm_eyes'},
    {sym:'hm_hair_1',tint:HAIR[2]}],
  headCompRng:[
    {sym:'hf_hair_2_back',tint:HAIR[2]},
    {sym:'hf_headSkin',tint:SKIN[2]},
    {sym:'hf_eyes'},
    {sym:'hf_hair_2',tint:HAIR[2]}],
};
